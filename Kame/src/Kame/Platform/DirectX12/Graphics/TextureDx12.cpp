...
namespace Kame {
  ...
  void TextureDx12::Create(size_t Width, size_t Height, DXGI_FORMAT Format, const void* InitialData) {
    ...
    //SetTextureUsage(textureUsage);
    SetD3D12Resource(textureResource);
    CreateViews();
    SetName(L"Texture");
