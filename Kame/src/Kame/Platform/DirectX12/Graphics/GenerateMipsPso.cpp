...
#include "Shaders/Compiled/GenerateMips_CS.h"
...
namespace Kame {
  ...
  GenerateMipsPSO::GenerateMipsPSO() {
    ...
    _RootSignature.SetRootSignatureDesc(
    ...
    pipelineStateStream.pRootSignature = _RootSignature.GetRootSignature().Get();
    ...
    _DefaultUAV = DX12Core::Get()->AllocateDescriptor(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 4);
    ...
    for (UINT i = 0; i < 4; ++i) {
      ...
      device->CreateUnorderedAccessView(
        ...
        _DefaultUAV.GetDescriptorHandle(i)
      );
    }
  }
